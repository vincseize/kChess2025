<?php
// footer.php - VERSION FINALE OPTIMISÉE v1.0.5
// Ordre de chargement : CORE -> VALIDATORS (Sliding first) -> BOTS -> STATUS -> UI -> EVENTS
?>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎮 K-Chess Engine - Système prêt (v<?php echo $version; ?>)');
