// move-validator-bishop.js - Validateur des mouvements de fou CORRIGÉ
class BishopMoveValidator {
    ...
    getPossibleMoves(piece, row, col) {
        ...
        const validMoves = moves.filter(move => {
            ...
            if (wouldBeInCheck) {
                console.log(`❌ Mouvement bloqué: fou [${row},${col}]->[${move.row},${move.col}] mettrait le roi en échec`);
            }
            return !wouldBeInCheck;
        });

        console.log(`🗂️ Fou ${pieceColor} en [${row},${col}]: ${moves.length} mouvements bruts, ${validMoves.length} valides`);
        return validMoves;
    }
